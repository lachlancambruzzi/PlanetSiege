...
/// <summary>
/// Manages the health of the Earth, updates UI, handles damage, and game over logic.
/// Attach this to the Earth GameObject (tagged "Earth").
/// </summary>
public class EarthHealthManager : MonoBehaviour
{
    ...
    private void UpdateHealthUI()
    {
        if (healthText != null)
        {
            healthText.text = $"Earth Health: {currentHealth}/{maxHealth}";
        }
    ...
    /// <summary>
    /// Updates the particle system to reflect Earth’s current health.
    /// </summary>
    ...
    /// <summary>
    /// Called when Earth reaches 0 health.
    /// </summary>
    private void GameOver()
    {
        Debug.Log("Game Over: Earth has been destroyed!");
